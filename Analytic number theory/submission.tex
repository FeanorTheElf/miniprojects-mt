...
\end{proof}
For the case of primes $\equiv 1 \mod 4$, I have remembered Fermat's theorem on the sum of two squares and its connection to primes in the ring $\Z[i]$ of Gaussian integers, and somehow my train of thoughts went into Algebraic Number Theory.
...
\begin{remark}[Question (vii)]
    ...
    \end{equation*}
    Note that we find $n \equiv a \mod q$ such that $n$ has no nontrivial factor $\equiv a \mod q$.
    E.g. take $n = 9 \equiv 4 \mod 5$, then
    \begin{equation*}
